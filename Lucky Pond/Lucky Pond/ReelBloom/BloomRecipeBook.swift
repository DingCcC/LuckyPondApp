...
enum BloomRecipeBook {
    ...
    private static let recipeMap: [String: (title: String, bloomYield: BloomYield, tip: String)] = {
        ...
        bloomMap[key([.firefly, .firefly, .firefly])] = ("Firefly Gleam", BloomYield(coins: 1260, energy: 6, buffTitle: "Warm Wake", buffMinutes: 12), "Three firefly marks brighten the next pond run.")
        bloomMap[key([.jadePearl, .jadePearl, .jadePearl])] = ("Jade Pearl Tide", BloomYield(coins: 840, pearls: 36, harmony: 8, materials: [ReedMaterial.pearlDust.rawValue: 3]), "Jade Pearl marks pull a calm pearl tide across the pond.")
        bloomMap[key([.goldScale, .goldScale, .goldScale])] = ("Gold Scale Run", BloomYield(coins: 1320, pearls: 21, lanternTokens: 30), "Gold Scale marks leave a bright trail of pond rewards.")
        ...
        bloomMap[key([.firefly, .jadePearl, .goldScale])] = ("Pond Blessing", BloomYield(coins: 1180, pearls: 30, energy: 6, harmony: 8), "A full rare-mark trio blooms from the pond's luckiest catch.")
